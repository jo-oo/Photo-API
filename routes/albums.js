...
const albumValidationRules = require('../validation/album_validation_rules');//importerar validation-rules för user
...
router.get('/:albumId', userController.showAlbum); 
...
router.post('/', userValidationRules.createUserRules, albumController.storeAlbum);
...
router.post('/:albumId/photos', albumValidationRules.addPhotoToAlbumRules, albumController.postPhoto);
